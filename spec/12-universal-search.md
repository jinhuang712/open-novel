...
| 数据源 | 提供什么 | 主权文档 |
|---|---|---|
| 文件/章节索引 | 文件名、章节名、路径、最近打开 | [Project Storage](./01-project-storage.md) |
| 知识图谱 | entity、alias、concept、relation、anchor | [Knowledge Graph](./06-knowledge-graph.md) |
| Context/Query | fact query、semantic recall、来源解释 | [Context And Query](./07-context-and-query.md) |
| Runtime State | 最近访问、当前 turn、history hint | [Runtime State](./02-runtime-state.md) |
| Editor | 当前选区、当前文件、打开/对照动作 | [Editor And Interaction](./10-editor-and-interaction.md) |
...
A: Search 可以展示“全项目改名”动作入口,但执行必须进入 [Approval Cascade](./15-approval-cascade.md) 和 turn/approval 语义。
