...
Universal Search 使用本篇的 fact query 和 semantic recall 作为底层能力,但它不是本篇的替代品。Search 的入口、排序、分组、hover preview 和快捷键语义见 [12 · Universal Search](./M01-universal-search.md)。
