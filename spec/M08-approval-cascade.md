...
pending approval 期间,Approval Cascade 是项目唯一可写焦点。Universal Search、Trace 和 Discuss 可以只读查看或解释当前审批,但任何会生成新 proposal、创建新 ChangeSet、修改当前审批卡前置条件或切换到可写模式的命令都必须被禁用或提示先处理待审卡。
