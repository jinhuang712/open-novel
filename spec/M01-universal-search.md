...
| Context/Query | fact query、semantic recall、来源解释 | [Context And Query](./S07-context-and-query.md) |
| Runtime State | 最近访问、当前 turn、history hint | [Runtime State](./S02-runtime-state.md) |
| Editor | 当前选区、当前文件、打开/对照动作 | [Editor And Interaction](./S10-editor-and-interaction.md) |
