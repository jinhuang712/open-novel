...
| low-confidence | 放入 Maybe Related 或弱提示,不能作为事实摘要。 |

Pending approval 中尚未生效的事实不能进入 Characters/Factions/Concepts 等派生事实展示。Search 可以在单独的“Pending changes”提示里说明某审批卡可能影响当前查询,并提供打开审批卡入口。
