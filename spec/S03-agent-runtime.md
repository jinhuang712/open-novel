...
- [appendix/tool-catalog](./appendix/A04-tool-catalog.md) 保存工具、命令和参数明细。
- [appendix/json-schemas](./appendix/A02-json-schemas.md) 保存结构化输出 schema。
- [appendix/prompt-templates](./appendix/A05-prompt-templates.md) 保存 prompt 模板和公共片段。
