...
- 落点: plan/09-narrative-engine.md, spec/S10-narrative-engine.md
...
- 落点: plan/10-reader-simulator.md, spec/S11-reader-personas.md
...
- **spec/S10-narrative-engine.md** — 新建
- **spec/S11-reader-personas.md** — 新建
- **README.md** — 文档导航追加 plan/09 + plan/10 + spec/S10 + spec/S11
