...
**日期**: 2026-04-30
**周次**: (跨期决策,影响 W2-W14 整套 UX 实现)
**主要 Owner**: jin.huang@klook.com
**状态**: docs 写完 / 等用户 approve / 实施分散到多个周

> 本条目按 docs-before-code 三段式 (docs → approve → code) 在战略升级 (002) 之后追加。捕捉一类 UX 治理决策,不属于具体周里程碑,但影响 W2 起所有 UX 实现细节。
...
> 本节将在 W2 commit 5 (Section 1) + W3 (其他 sections + shortcut registry) 各自完成后追加。
