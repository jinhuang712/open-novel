...
| ID | 问题 | 关联文档 | 为什么不能直接关闭 | 关闭条件 |
|---|---|---|---|---|
| TODO-P1-50 | S03 尚未统一 turn canonical terminal enum,且没有显式吸收 S02/S05 的 interrupted 恢复路径。 | [S02](./spec/S02-agent-runner.md) · [S03](./spec/S03-turn-orchestration.md) · [S04](./spec/S04-streaming-ui-protocol.md) · [S14](./spec/S14-project-storage.md) · [M17](./spec/M17-turn-recap-and-continuation.md) | 这是状态主权修复,方向清楚:同一终态只能由 S03 定义并向 S14/S05/M17 投影。 | S03 增加 canonical turn terminal enum,明确 Completed/Applied/ApplyFailed/Interrupted/ManualRecovery 等映射;S02/S04/S05/M17/A03/V01 同步。 |
