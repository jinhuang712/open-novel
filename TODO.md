...
截至 2026-06-12,本仓库没有未归口的活跃 TODO。已归口的架构风险不再重复放在这里,而是进入对应 plan/spec/platform/appendix 文档;需要真实代码、依赖或运行数据证明的事项进入 V01/V02/V03。

## 已清理问题族

本轮 plan/spec/design 架构复查发现的待办已经归口:
...
| 设计风险等级、ReaderPanel 总分心智、主界面窄窗/长卷/状态密度规则 | [design/00](./design/00-design-tokens.md) · [design/01](./design/01-main-layout.md) · [design/02](./design/02-approval-cascade.md) · [design/03](./design/03-reader-panel.md) · `design/prototypes/02-approval-cascade.html` · `design/prototypes/03-reader-panel.html` |
...
需要真实代码、依赖或运行数据证明的事项不作为 TODO 漂浮:
