...
- **可独立调配**。每个角色独立设档、独立开关:高消耗的能力可以整个关掉,轻量的保持常开;节省消耗关掉的是整个角色,而不是让留下的角色偷工减料(见 [02 — 产品原则](./02-principles.md) 原则七)。
...
**档位按角色可调。** 高消耗能力优先给核心创作与一致性把关,轻量能力优先给调度、提示、预演和复盘。每个角色的用量档位都可单独调整,但节省消耗的方式是调低或关闭明确能力,不是让保留的能力偷工减料(见 [02 — 产品原则](./02-principles.md) 原则七)。
