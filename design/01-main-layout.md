...
推开式面板让纸面让位不被遮挡;输入条、批阅层近文操作与审批卡是召唤层。各区尺寸见上图与下文各节;快捷键以 [spec/S14](../spec/S14-editor-and-interaction.md) 为准。
...
| 60 | 查询浮层 / Universal Search / 命令面板 / 快速打开 / @引用 | 轻浮层 | 同组互斥,后打开者关闭先打开者 |
