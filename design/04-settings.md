...
| 10 快捷键 | 🌐 | 快捷键查看与重绑 |
| 11 帮助 | 🌐 | 新手提示回看、文档入口和支持信息 |
| 12 关于 | 🌐 | 版本、隐私边界和 dev build 只读标记 |
