...
> 原型:`design/prototypes/06-command-palette.html` · 上游:[spec/12 快捷键 Registry](../spec/12-shortcuts.md)(命令清单 / 上下文优先级 / IME 闸门以 spec 为准)
...
- chip 在发送 prompt 时展开为 `[@角色名](mention://char_xxx)` 契约形态([spec/12 §@文件名引用](../spec/12-shortcuts.md#文件名引用))
