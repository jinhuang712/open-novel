...
3. **纸面唯一主角(写作优先)**:默认界面只有章节轨、纸面、状态点三样;库、对话、trace、调试全部召唤式出现,用完即走。IDE 只保留肌肉记忆(快捷键 / 多章 / 对照 / Goto Definition),不保留常驻外观([plan/07](../plan/07-ui-layout.md) ADR-01/04/05,2026-06-11 修订)
