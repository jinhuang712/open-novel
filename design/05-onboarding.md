...
| 3 第一个项目 | 推荐卡「加载样例项目〈重生互联网〉」(badge-accent「推荐 · 5 分钟看懂全流程」,列出含 3 角色 / 第 1 章 / 5 条审批历史)vs 空白表单(项目名 / 流派下拉 / 风格描述 / 故事种子 textarea) | 二选一卡片;选空白时表单就地展开,项目名必填。未填项目名时「下一步」disabled,输入框 danger 描边并显示「先给项目起个名字」 |
