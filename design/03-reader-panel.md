...
> 原型:`design/prototypes/03-reader-panel.html` · 上游:[plan/10 叙事诊断与读者预演](../plan/10-narrative-and-reader.md) · [spec/11 读者 Persona](../spec/11-reader-personas.md)
...
- 触发后 ChatBox 顶部进度条:「ReaderPanel · 3/5 · 毒舌读者 · 4.5s」([plan/06 §长任务体验](../plan/06-collaboration-and-modes.md#长任务体验))
